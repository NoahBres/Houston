...
export default function AccelerometerGraphCard({
  ...
  useInterval(() => {
    if (missionControlState.isLogging && settings.updateAccelGraph) {
      if (
        accelerometerXRaw.current &&
  ...
  return (
    <Card className={`${className} overflow-hidden p-6 relative`}>
        ...
        <div className="w-1/2 inline-block">
          ...
          <h2 className="text-3xl font-thin">
            ...
            <span
              role="img"
              aria-label="x"
              style={{ display: settings.updateAccelGraph ? "none" : "" }}
            >
              ❌
            </span>
          </h2>
        ...
        <div className="w-1/2 inline-flex justify-end">
          <div className="relative">
            ...
            <Dropdown
              ...
              position="top"
              className="bg-white text-black p-2 mt-2 rounded transition-300-ease w-40 z-50"
            ...
            >
              <label
                ...
                htmlFor="update-accel-graph"
              >
                <input
                  type="checkbox"
                  name="updateAccelGraph"
                  checked={settings.updateAccelGraph}
                  onChange={settingsHandleInputChange}
                  id="update-accel-graph"
                />
                <span className="ml-3">Update Graph</span>
              </label>
            </Dropdown>
          </div>
        </div>
